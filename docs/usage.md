...
```bash
nextflow run MDL/metabolt --input ./samplesheet.csv --outdir ./results --genome GRCh37 -profile docker
```
...
```bash
nextflow run MDL/metabolt -profile docker -params-file params.yaml
```
